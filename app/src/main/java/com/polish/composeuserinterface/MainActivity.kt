        ...
        setContent {
            ComposeUserInterfaceTheme {
                ...
                Surface(
                    ...
                    GreetSamWithImage(name = "Sam", sender = "Emma")
                }
            }
        }
    }
...
fun GreetSam() {
    Column {
        Text(text = "Happy Birthday Sam!", fontSize = 36.sp)
        Text(text = "- from Emma")
    }
}

@Composable
fun GreetSamWithImage(name: String, sender: String) {
    val image = painterResource(id = R.drawable.slide5)
    Box {
        Image(
            painter = image,
...
fun DefaultPreview() {
    ComposeUserInterfaceTheme {
        GreetSamWithImage(name = stringResource(R.string.celebrant_name), sender = "Emma")
    }
}
